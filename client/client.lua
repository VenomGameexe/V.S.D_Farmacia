...
local store = {  ----nome del blip-----
    [_U('open_store')] = { title="Farmacia", size= 10, colour=34, id=51, x = 317.91, y = -1076.62, z = 28.479}, 
} 

local NPC = {
    {seller = true, model = "s_m_m_doctor_01", x = 318.34, y = -1078.72, z = 28.479, h = 349.337},
}
        ...
        'default', GetCurrentResourceName(), 'Pharmacy_markets',
         {
            ...
            elements = {
				{label = ('Bende - <span style="color:green;">350$</span>'), item = 'bandage', price = 350, amount = 1},
            }
        },
        function(data, menu)
